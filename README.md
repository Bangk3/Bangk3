...
### 🚀 Main Tech Stack
- **C++**: High-performance systems & algorithms
- **Node.js**: Modern backend & API development
- **Laravel**: Elegant PHP web applications

---

## 🌱 About Me
- 💡 Passionate about building scalable and efficient software
- 🛠️ Love exploring new technologies and best practices
- 🤝 Open to collaboration on open-source and interesting projects
